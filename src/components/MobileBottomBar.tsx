...
export const MobileBottomBar = () => {
  ...
  return (
    <motion.div 
      ...
      className="fixed bottom-2.5 left-1/2 -translate-x-1/2 z-50 sm:hidden w-[86%] max-w-[290px] flex flex-col items-center pointer-events-auto transform-gpu"
    >
      
      {/* 1. TOP SCROLL TO TOP CHEVRON ARROW */}
      <button 
        onClick={scrollToTop}
        className="mb-0.5 text-white opacity-80 hover:opacity-100 active:scale-125 transition-all focus:outline-none p-0.5 drop-shadow transform-gpu"
      ...
      <div className="w-full bg-[#18191c]/95 backdrop-blur-xl border border-neutral-700/80 rounded-[18px] py-1.5 px-1 shadow-[0_6px_25px_rgba(0,0,0,0.85)] transform-gpu">
        <div className="grid grid-cols-3 divide-x divide-neutral-700/80 items-center w-full">
          ...
          <a
            ...
            className="flex flex-col items-center justify-center px-0.5 active:scale-90 transition-transform duration-150 transform-gpu"
