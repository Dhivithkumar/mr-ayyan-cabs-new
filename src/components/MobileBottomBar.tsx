...
export const MobileBottomBar = () => {
  ...
  return (
    <div className="fixed bottom-3 left-1/2 -translate-x-1/2 z-50 sm:hidden w-[92%] max-w-[340px] flex flex-col items-center pointer-events-auto">
      
      {/* 1. TOP SCROLL TO TOP CHEVRON ARROW */}
      <button 
        onClick={scrollToTop}
        className="mb-1 text-white opacity-80 hover:opacity-100 transition-opacity focus:outline-none p-1 drop-shadow"
      ...
      <div className="w-full bg-[#18191c]/95 backdrop-blur-xl border border-neutral-700/80 rounded-[22px] py-2 px-1 shadow-[0_8px_30px_rgba(0,0,0,0.85)]">
        <div className="grid grid-cols-3 divide-x divide-neutral-700/80 items-center w-full">
          
          {/* COLUMN 1: CALL */}
          <a
            href="tel:+919786223334"
            className="flex flex-col items-center justify-center px-1 active:scale-95 transition-transform"
          ...
          >
            ...
            <span className="text-[10px] font-bold text-white tracking-wider uppercase mt-1.5 font-heading">
              CALL
            </span>
          </a>
          ...
          >
            <div className="w-10 h-10 rounded-full bg-neutral-900/90 border border-neutral-600 flex items-center justify-center shadow-md">
