        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 tracking-tight mb-4 font-heading">
              Areas We Serve in Tirupur District
            </h2>
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto font-medium">
              Mr Ayyan Cabs provides prompt cab pickup across all major residential, commercial, industrial, and textile hub locations in Tirupur.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-amber-500/10 border border-amber-500/30 p-8 rounded-3xl flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left shadow-sm">
            <div>
